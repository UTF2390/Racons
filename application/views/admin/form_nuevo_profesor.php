...
<form enctype="multipart/form-data" action="http://localhost/Racons/index.php/admin/nuevo_profesor" method='POST'>
    <text>Nombre</text>
    ...
    <select name="administrador">
        <option value = "0" selected="selected">No Administrador</option>
